...
const App = () => {
  ...
  //this function gets triggered only if any of the number buttons(0-9) is pressed. It gets the value and adds it to the current num value
  ...
  //this function gets triggered only if the decimal point is pressed. it adds the decimal point to the current num value making it a decimal number
 ...
 //this function checks if theres any entered value or calculated res and then calculates the percentage using the built-in Math.pow function which returns the base to the exponent power
